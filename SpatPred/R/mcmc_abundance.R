#' function to perform Bayesian analysis of count data using a spatial log Gaussian Cox process model
...
#'        Grid - A data frame holding covariate values for all cells one wants to make predictions on (including sampled cells)
