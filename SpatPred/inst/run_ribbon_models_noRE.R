...
tmp6=tmp2[which(tmp2[,"I.negative"]==1),]
tmp.theme=theme(axis.ticks = element_blank(), axis.text = element_blank())
p1.ice0=ggplot(tmp2)+aes(Easting,Northing,fill=Abundance)+geom_raster()+tmp.theme
p1.ice0=p1.ice0+scale_fill_gradientn(colours=myPalette(100))+
  guides(fill = guide_colorbar())
#if(nrow(tmp5)>0)p1=p1+geom_rect(data=tmp5,size=0.5,fill=NA,colour="green",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
#if(nrow(tmp6)>0)p1=p1+geom_rect(data=tmp6,size=0.5,fill=NA,colour="red",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
#if(nrow(tmp4)>0)p1=p1+geom_rect(data=tmp4,size=0.5,fill=NA,colour="yellow",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
if(nrow(tmp3)>0)p1.ice0=p1.ice0+geom_rect(data=tmp3,size=0.5,fill=NA,colour="black",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
p1.ice0
#print(p1,vp=viewport(layout.pos.row=1,layout.pos.col=1))
pdf(file="ribbon_glm_ice0.pdf")
p1.ice0
dev.off()
...
tmp6=tmp2[which(tmp2[,"I.negative"]==1),]
tmp.theme=theme(axis.ticks = element_blank(), axis.text = element_blank())
p2.ice0=ggplot(tmp2)+aes(Easting,Northing,fill=Abundance)+geom_raster()+tmp.theme
p2.ice0=p2.ice0+scale_fill_gradientn(colours=myPalette(100))+
  guides(fill = guide_colorbar())
#if(nrow(tmp5)>0)p1=p1+geom_rect(data=tmp5,size=0.5,fill=NA,colour="green",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
#if(nrow(tmp6)>0)p1=p1+geom_rect(data=tmp6,size=0.5,fill=NA,colour="red",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
#if(nrow(tmp4)>0)p1=p1+geom_rect(data=tmp4,size=0.5,fill=NA,colour="yellow",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
if(nrow(tmp3)>0)p2.ice0=p2.ice0+geom_rect(data=tmp3,size=0.5,fill=NA,colour="black",aes(xmin=Easting-25067/2,xmax=Easting+25067/2,ymin=Northing-25067/2,ymax=Northing+25067/2))
pdf("gam_ice0.pdf")
p2.ice0
dev.off()

library(gridExtra)
pdf(file="Bering_noRE_maps.pdf")
grid.arrange(arrangeGrob(p1,p2,p1.ice0,p2.ice0,nrow=2))
dev.off()
